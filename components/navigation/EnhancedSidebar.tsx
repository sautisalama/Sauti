...
export function EnhancedSidebar({ defaultCollapsed = false, className }: EnhancedSidebarProps) {
  ...
  const getSidebarItems = (): SidebarItem[] => {
    ...
    if (!isDashboard) {
      return [
        ...
        { id: "weather", label: "Weather Safety", icon: Cloud, href: "/weather", section: "main" },
        { id: "about", label: "About", icon: HelpCircle, href: "/about", section: "main" },
        { id: "report", label: "Report Incident", icon: Megaphone, onClick: () => setReportDialogOpen(true), section: "main" },
        { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, href: "/dashboard", section: "secondary", separator: true },
      ];
    }

    const baseItems: SidebarItem[] = [
      { id: "overview", label: "Overview", icon: LayoutDashboard, href: "/dashboard", section: "main" },
      { id: "chat", label: "Messages", icon: MessageCircle, href: "/dashboard/chat", badge: 3, section: "main" },
      { id: "resources", label: "Resources", icon: FileText, href: "/dashboard/resources", section: "main" },
    ];
    ...
    return [
      ...baseItems,
      { id: "profile", label: "Profile", icon: User, href: "/dashboard/profile", section: "secondary", separator: true },
      { id: "settings", label: "Settings", icon: Settings, href: "/dashboard/settings", section: "footer" },
    ];
  };
  ...
  const SidebarItemComponent = ({ item }: { item: SidebarItem }) => {
    ...
    const content = (
      <div className={cn(
        ...
        active && "bg-sauti-orange/10 text-sauti-orange border-r-2 border-sauti-orange"
      )}>
        <div className="relative flex items-center justify-center">
          <Icon className={cn(
            "h-5 w-5 transition-colors",
            active ? "text-sauti-orange" : "text-neutral-600 dark:text-neutral-400 group-hover:text-sauti-orange"
          )} />
        ...
        {!isCollapsed && (
          <span className={cn(
            ...
            active ? "text-sauti-orange" : "text-neutral-700 dark:text-neutral-300 group-hover:text-sauti-orange"
          )}>
            {item.label}
          </span>
        )}
        ...
        <div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-800">
          {!isCollapsed && (
            <Link href="/dashboard" className="flex items-center gap-3">
              <Image src="/logo.webp" alt="Sauti Salama" width={32} height={32} className="rounded-lg" />
              <div>
      ...
      <Dialog open={reportDialogOpen} onOpenChange={setReportDialogOpen}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Your safety and privacy are our priority. All information will be kept confidential.
            </DialogDescription>
          </DialogHeader>
