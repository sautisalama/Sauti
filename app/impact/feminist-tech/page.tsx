                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-12 lg:px-32 max-w-[1400px]">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                            <FeatureCard icon={<ShieldCheck className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Scale Protection" description="Protecting 5,000+ survivor interactions through end-to-end encryption." />
                            <FeatureCard icon={<Zap className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Rapid Response" description="Low-latency reporting tools for immediate crisis management." />
                            <FeatureCard icon={<Database className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Data Sovereignty" description="Ensuring survivors have complete ownership and control over their data." />
                            <FeatureCard icon={<Terminal className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Tech Literacy" description="Bridging the digital divide for 1,000+ women in grassroots organizing." />
                        </div>
                    </div>
                </section>
            </main>
