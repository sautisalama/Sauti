                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-12 lg:px-32 max-w-[1400px]">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                            <FeatureCard icon={<Leaf className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Resilience" description="Building community safety nets that withstand environmental shocks." />
                            <FeatureCard icon={<Sunrise className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Resource Access" description="Ensuring survivors have access to basic needs during climate crises." />
                            <FeatureCard icon={<Shield className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Advocacy" description="Driving global policy at COP30 for gender-just climate action." />
                            <FeatureCard icon={<Cloud className="w-6 h-6 md:w-8 md:h-8 text-sauti-orange" />} title="Safety Circles" description="Establishing 'Circles of Safety' in regions hit hardest by climate change." />
                        </div>
                    </div>
                </section>
            </main>
