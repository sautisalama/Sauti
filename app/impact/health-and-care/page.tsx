                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-12 lg:px-32 max-w-[1400px]">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-20 lg:mb-32">
                            <FeatureCard icon={<Stethoscope className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Medical Aid" description="Immediate medical assistance and long-term diagnostic support." />
                            <FeatureCard icon={<Brain className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Mental Health" description="Trauma-informed counselling and psychiatric services." />
                            <FeatureCard icon={<HeartPulse className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Holistic Care" description="Wellness programs focusing on physical and emotional restoration." />
                        ...
                        <div className="bg-[#fff1f2] rounded-[32px] md:rounded-[60px] p-8 md:p-16 lg:p-20 flex flex-col md:flex-row gap-8 lg:gap-16 items-center">
                            <div className="md:w-1/2">
                                ...
                                <ul className="space-y-3 md:space-y-4 mb-8 md:mb-10">
                                    <li className="flex items-center gap-3 md:gap-4 text-base md:text-xl font-bold text-sauti-dark">
                                        <div className="w-2 md:w-3 h-2 md:h-3 rounded-full bg-sauti-yellow" />
                                ...
                                <Link href="/volunteer">
                                    <Button className="rounded-full bg-white text-sauti-dark border-2 border-sauti-dark px-6 md:px-8 py-4 md:py-6 text-base md:text-lg font-bold hover:bg-sauti-dark hover:text-white transition-all">
                                        Join a Cafe Session
                                    </Button>
                                </Link>
                            </div>
