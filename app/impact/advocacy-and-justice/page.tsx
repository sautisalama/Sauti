                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-12 lg:px-32 max-w-[1400px]">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-20 lg:mb-32">
                            <FeatureCard icon={<Gavel className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Legislative Input" description="Contributing survivor voices to national justice and safety frameworks." />
                            <FeatureCard icon={<Megaphone className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Mobilization" description="Building grassroots movements to demand accountability and safety." />
                            <FeatureCard icon={<FileText className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Evidence" description="Using data and survivor stories to influence public policy." />
                            <FeatureCard icon={<Globe className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Global Action" description="Partnering with international organizations for sustained impact." />
                        </div>

                        <div className="mb-20">
                            <h2 className="text-2xl md:text-5xl lg:text-6xl font-black text-sauti-dark mb-10 md:mb-12 uppercase tracking-tighter text-center">Mobilizing for Justice</h2>
    ...
    return (
        <div className="group relative aspect-[3/4] rounded-[24px] md:rounded-[40px] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500">
            ...
            <div className="absolute bottom-6 md:bottom-10 left-6 md:left-10 right-6 md:right-10">
                <span className="text-sauti-yellow font-bold text-xs md:text-sm uppercase tracking-widest mb-2 block">{year}</span>
