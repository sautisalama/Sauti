                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-12 lg:px-32 max-w-[1400px]">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                            <FeatureCard icon={<GraduationCap className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Mentorship" description="Connecting young activists with experienced feminist leaders." />
                            <FeatureCard icon={<HandMetal className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Activism" description="Training on grassroots organizing and community mobilization." />
                            <FeatureCard icon={<Sparkles className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Innovation" description="Supporting youth-led solutions for digital and physical safety." />
                            <FeatureCard icon={<Users className="w-6 h-6 md:w-8 md:h-8 text-sauti-yellow" />} title="Safe Spaces" description="Creating inclusive environments for youth to learn and lead." />
                        </div>
                    </div>
                </section>
            </main>
