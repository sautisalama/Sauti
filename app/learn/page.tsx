    ...
    return (
        <article className="group cursor-pointer">
            <div className="aspect-[16/10] relative rounded-[24px] md:rounded-[40px] overflow-hidden mb-4 md:mb-8 bg-white shadow-xl border-2 border-gray-50 group-hover:shadow-2xl transition-all duration-500">
                ...
                <div className="absolute top-4 md:top-6 left-4 md:left-6 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-white/95 backdrop-blur-sm text-sauti-dark text-[10px] md:text-xs font-black uppercase tracking-widest shadow-sm">
                    {category}
                </div>
            </div>
