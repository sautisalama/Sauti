                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-sauti-dark mb-6 md:mb-8 leading-tight">
                                    Feminist <CircledText circleColor="#00CF8D">Tech</CircledText>
                                </h1>
                ...
                <section className="py-24 bg-white">
                    <div className="container mx-auto px-6 max-w-7xl">
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <FeatureCard icon={<Lock className="w-8 h-8 text-sauti-yellow" />} title="Encryption" description="Military-grade security for all survivor communication and reports." />
                            <FeatureCard icon={<Smartphone className="w-8 h-8 text-sauti-yellow" />} title="Anonymous Mode" description="Access resources and report harm without revealing your identity." />
                            <FeatureCard icon={<Cpu className="w-8 h-8 text-sauti-yellow" />} title="Open Source" description="Transparent, community-governed technology auditing and development." />
                            <FeatureCard icon={<Laptop className="w-8 h-8 text-sauti-yellow" />} title="Digital Literacy" description="Training survivors on operational security and online safety." />
                        </div>
                    </div>
                </section>
            </main>
