            ...
            <main className="flex-1">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-sauti-dark mb-6 md:mb-8 leading-tight">
                                    Access to <CircledText circleColor="#00CF8D">Care</CircledText>
                                </h1>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link href="/signup">
                                        <Button className="rounded-full bg-sauti-yellow text-sauti-yellow px-8 py-7 text-lg font-black shadow-xl hover:bg-sauti-yellow/90 transition-all">
                                            Get Immediate Help
                                        </Button>
                                    </Link>
                                    <Link href="/signup">
                ...
                <section className="py-24 bg-gray-50 border-y border-gray-100">
                    <div className="container mx-auto px-6 max-w-4xl text-center">
                        <h2 className="text-4xl md:text-6xl font-black text-sauti-dark mb-10">Holistic Recovery.</h2>
                        ...
                        <div className="bg-sauti-dark rounded-[40px] p-12 text-white relative overflow-hidden group">
                            ...
                            <Button className="rounded-full bg-sauti-yellow text-sauti-yellow px-10 py-7 text-xl font-black shadow-xl hover:scale-105 transition-transform hover:bg-sauti-yellow/90">
