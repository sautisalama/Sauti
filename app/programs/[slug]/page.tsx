...
const PROGRAM_DATA: Record<string, any> = {
    "access-to-care": {
        ...
        icon: <Heart className="w-16 h-16 text-sauti-orange" />,
    ...
    "prevention": {
        ...
        icon: <Shield className="w-16 h-16 text-sauti-orange" />,
    ...
    "legal-access": {
        ...
        icon: <Scale className="w-16 h-16 text-sauti-orange" />,
    ...
    "feminist-tech": {
        ...
        icon: <Landmark className="w-16 h-16 text-sauti-orange" />,
            ...
            <main className="flex-1">
                <section className="py-24 md:py-32 bg-[#f4f7fa]">
                    <div className="container px-4 max-w-7xl mx-auto">
                        <Link href="/programs" className="flex items-center gap-2 text-sauti-blue font-black mb-12 hover:translate-x-[-8px] transition-transform">
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <h1 className="text-4xl md:text-8xl font-serif font-black text-sauti-blue mb-6 leading-tight">
                                    {program.title}
                                </h1>
                                <p className="text-xl md:text-2xl text-sauti-orange font-bold uppercase tracking-widest">{program.subtitle}</p>
                            </div>
                ...
                <section className="py-24">
                    <div className="container px-4 max-w-7xl mx-auto">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-black text-sauti-blue mb-10 md:mb-16 border-b-4 md:border-b-8 border-sauti-orange/20 pb-4 md:pb-6 w-fit">Deep Dive.</h2>
                            <div className="space-y-12">
                                {program.details.map((detail: string, i: number) => (
                                    <div key={i} className="flex gap-4 md:gap-8 items-start">
                                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl md:rounded-3xl bg-sauti-blue text-white flex items-center justify-center shrink-0 shadow-lg">
                ...
                <section className="py-24 bg-[#1a365d] text-white overflow-hidden">
                    <div className="container px-4 text-center relative z-10">
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            <Link href="/volunteer">
                                <Button className="rounded-full bg-[#ebc13d] text-[#00473e] px-8 md:px-12 py-6 md:py-10 text-xl md:text-2xl font-black hover:scale-105 transition-transform hover:bg-[#d4ac31]">
                                    Join Our Collective
                                </Button>
                            </Link>
                            <Link href="/impact">
