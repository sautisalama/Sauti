...
export default function CaseNotesEditor({
	...
	const editor = useEditor({
		...
		editorProps: {
			...
			attributes: {
				class:
					"tiptap prose-sm max-w-none focus:outline-none break-words whitespace-pre-wrap min-h-[200px] p-3",
			},
		},
	});
	...
	if (!editor || !editor.chain)
		return (
			<Card className="p-0 border">
				<div className="p-3 text-sm text-neutral-500">Loading editor…</div>
			</Card>
		);
