                    ...
                    <div className="space-y-12 md:space-y-16">
                        ...
                        <section>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                                <div className="bg-orange-50 p-6 md:p-8 rounded-xl md:rounded-2xl border border-orange-100">
                                ...
                                <div className="bg-sauti-blue/5 p-6 md:p-8 rounded-xl md:rounded-2xl border border-sauti-blue/10">
                                ...
                                <div className="bg-green-50 p-6 md:p-8 rounded-xl md:rounded-2xl border border-green-100">
                        ...
                        <section className="bg-sauti-blue rounded-2xl md:rounded-[48px] p-8 md:p-12 text-white">
